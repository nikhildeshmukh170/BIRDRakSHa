...
const BirdUploadSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col md:flex-row w-full max-w-7xl gap-6 md:gap-20 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-4 md:p-6 flex-1 bg-gradient-to-br from-white to-lime-200 relative text-left rounded-lg backdrop-blur-sm">
          ...
          <div className="mt-4 md:mt-6 p-4 bg-green-200 bg-opacity-30 rounded-lg shadow-sm hover:bg-green-400 hover:bg-opacity-30">
        ...
        <div className="p-4 md:p-6 flex-1 text-center border-2 border-green-400 shadow-inner flex flex-col rounded-lg backdrop-blur-sm">
